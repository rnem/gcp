...
### This project from Google Cloud Labs contains two versions of the same application, one architected as a monolith and the other as a set of microservices.
...
```bash
DOWNLOAD monolith-to-microservices from my GCP git repository
ZIP THE monolith-to-microservices FOLDER
UPLOAD THE ZIP FILE TO YOUR CLOUD SHELL
